...
return new class extends Migration
{
    ...
    {
        Schema::create('billing_plan_payment_provider_information', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            ...
            $table->index(['payment_provider_plan_id', 'payment_provider']);
        });
    }
    ...
    {
        Schema::dropIfExists('billing_plan_payment_provider_information');
    }
};
