...
class Checkout implements Responsable
{
    ...
    public function withCustomerBillingAddress(?CustomerBillingAddressData $customerBillingAddress = null): self
    {
    ...
    public function createCheckoutSessionData(): CreateCheckoutSessionData
    {
        $data = [
        ...
        return CreateCheckoutSessionData::fromArray($data, false);
    }
    ...
    {
        $request = $this->createCheckoutSessionData();

        $checkout = Polar::createCheckoutSession($request);
    ...
    public function checkoutSession(): CheckoutSessionData
    {
        $request = $this->createCheckoutSessionData();
